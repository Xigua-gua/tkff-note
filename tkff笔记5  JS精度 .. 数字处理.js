...
以前一直以为toFixed就是四舍五入的方法，后来又有一段时间以为toFixed是五舍六入。今天终于写的时候，终于才知道toFixed是一个叫做四舍六入无成双的诡异
的方法。。。
...
toFixed使用的是银行家舍入规则。 银行家舍入:所谓银行家舍入法，其实质是一种四舍六入五取偶（又称四舍六入五留双）法。 
简单来说就是：四舍六入五考虑，五后非零就进一，五后为零看奇偶，五前为偶应舍去，五前为奇要进一。 
但是不论引入toFixed解决浮点数计算精度缺失的问题也好，它有没有使用银行家舍入法也罢，都是为了解决精度的问题，但是又离不开二进制浮点数的环境，
但至少他帮助我们找到了问题所在，从而让我们有解决方法。
